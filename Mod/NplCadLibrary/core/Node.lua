...
local Node = commonlib.inherit(commonlib.gettable("Mod.NplCadLibrary.core.Transform"), commonlib.gettable("Mod.NplCadLibrary.core.Node"));
...
function Node:GetAllLogs()
	return self.logs;
end

function Node:ClearLogs()
	self.logs = nil;
end