...
linear_extrude({ offset = {0,0,10} , twistangle = 360, twiststeps = 100, } , rectangle({ center = {0,0}, radius = {1,1}, attach = false, }));
linear_extrude({ offset = {0,0,10} , twistangle = 360, twiststeps = 100, } , roundedRectangle({ center = {0,0}, radius = {1,1}, attach = false, }));
linear_extrude({ offset = {0,0,10} , twistangle = 360, twiststeps = 100, } , circle({ r = 1, center = true, attach = false, }));
linear_extrude({ offset = {0,0,10} } , ellipse({ radius = {2,4}, attach = false, }));
